mviewer.customControls.showAvailableStations = (function () {
    /*
     * Private
     */
    ...
    function processShowAvailableStations(rqtWPS) {
    ...
    return {
        ...
        init: function () {
            ...
            $("#legend-showAvailableStations").hide();
            $(".mv-layer-options[data-layerid='showAvailableStations'] .form-group-opacity").hide();
        },
        ...
        process: function () {
            if (_xy) {
                ...
                var dictInputs = {
                                X: String(_xy).split(',')[0],
                                Y: String(_xy).split(',')[1],
                                Start: $("#dateStartShowAvailableStations").val(),
                                End: $("#dateEndShowAvailableStations").val(),
                                Distance: [$("#distanceStationsShowAvailableStations").val()]
                };
                ...
                // execute le process
                processShowAvailableStations(_rqtWPS);
            } else {
