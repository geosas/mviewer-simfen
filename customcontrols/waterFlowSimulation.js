mviewer.customControls.waterFlowSimulation = (function () {
    ...
    return {
        ...
        waterFlowSimulation: function () {
            if (_xy) {
                if ($("#listStationsWaterFlowSimulation").val() === "") {
                    listStations = "None";
                //condition pour verifier que l'utilisateur respecte bien la
                //syntaxe de la liste des stations
                } else if ((((($("#listStationsWaterFlowSimulation").val().length > 8 
                    && $("#listStationsWaterFlowSimulation").val()[8] === ",") 
                    || ($("#listStationsWaterFlowSimulation").val().length === 8)) === true) 
                    && (/\s/.test($("#listStationsWaterFlowSimulation").val())) === false)) {
                    listStations = $("#listStationsWaterFlowSimulation").val();
                } else {
